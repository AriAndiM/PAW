...
<body style="background-image:url('sma (2).png');background-size:cover;background-repeat:no-repeat;">
    <center><h1 style="margin-top: 30px;margin-bottom:20px;">Edit Siswa XII IPA</h1></center>
    ...
    <div class="container" style="width:max-content;text-align:center;background-color:#3BCCB6;margin-top:50px;border-radius:8%;">
        <form action="action edit siswa 12 ipa.php" method="POST" style="padding:30px;">
        <input type="hidden" name="ID" value="<?php echo $row['ID'] ?>">
            ...
            <div>
                ...
                <a class="btn btn-danger btn-lg" style="padding-left: 2.5rem; padding-right: 2.5rem;" href="12 ipa.php">Back</a>
            </div>
        </form>
    <?php } ?>
    </div>
