...
<body style="background-image:url('sma (2).png');background-size:cover;background-repeat:no-repeat;">
    <center><h1 style="margin-top: 30px;margin-bottom:20px;">Edit Jurusan</h1></center>
    ...
    <div class="container" style="width:max-content;text-align:center;background-color:#3BCCB6;margin-top:50px;border-radius:8%;">
        <form action="action edit jurusan.php" method="POST" style="padding:30px;">
        <input type="hidden" name="ID" value="<?php echo $row['ID'] ?>">
            ...
            <div class="input-group flex-nowrap">
                ...
                <input type="text" class="form-control" name="Nama_Jurusan" value="<?=$row['Nama_Jurusan']?>"  aria-describedby="addon-wrapping" />
            </div><br>
            <div>
