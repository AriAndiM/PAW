...
<body style="background-image:url('https://img.freepik.com/free-photo/abstract-blue-extruded-voronoi-blocks-background-minimal-light-clean-corporate-wall-3d-geometric-surface-illustration-polygonal-elements-displacement_1217-2510.jpg?size=626&ext=jpg&ga=GA1.2.1445788865.1654314075');background-size:cover;background-repeat:initial;">
    ...
    <div class="w3-sidebar w3-dark w3-bar-block" style="width:20%;padding:20px;background-color: rgb(19, 110, 155); color:white">
        <img src="walidash.png" style="width: 280px;" alt="">  
        <a href="homewali.php" class="w3-bar-item w3-button">Home</a>
        <a href="opsi kelas siswa.php" class="w3-bar-item w3-button">Daftar Siswa</a>
    ...
    <div class="container" style="text-align:center;">
        <marquee behavior="scroll" direction="right" ><h1 style="font-family: Comic Sans;font-size:50px;color:beige">Selamat Datang Di Halaman Wali Kelas</h1></marquee>
        <p style="font-family: Brush Script MT;font-size:30px;color:beige;">Kini anda dapat melakukan pengeditan,peghapusan,<br>serta penambahan data siswa</p>
        <center><img src="wali.png" alt=""></center>
    </div>
</body>
</html>