...
<body style="background-color: rgb(19, 110, 155);" >
    ...
    <center><h1>Siswa XI IPA</h1></center>
    <br>
    <div class="text-center text-lg-start mt-4 pt-2">
        <a class="btn btn-light btn-lg" style="padding-left: 2.5rem; padding-right: 2.5rem;margin-right:3rem;" href="form tambah siswa 11 ipa.php">Tambah Siswa</a><br>
    </div>
    <table class="table" style="color:white;" >
            ...
            $query="SELECT * FROM siswa WHERE KelasID='K003'";
            ...
            <tr>
                ...
                <td>
                    <a style="text-decoration: none;color:#008CBA" href="form edit siswa 11 ipa.php?Id=<?php echo $row['ID'];?>"><span class="badge bg-primary">Edit</span></a>
                    |
                    <a style="text-decoration: none;color:#008CBA" href="delete siswa 11 ipa.php?Id=<?php echo $row['ID'];?>"><span class="badge bg-danger">Delete</span></a>  
                </td>
            <?php } ?>
        </table>
