...
<body>
    ...
    <form action="login.php" method="POST">
        ...
        <button type="submit" value="login" style="width: 100%;background-color:green;color:white;border:1px;height:40px;">Login</button>
        <input type="checkbox" value="remember" name="remember" style="margin-top: 10px;font-family:arial;">Remember Me
    </form>
    </div>
</body>
</html>